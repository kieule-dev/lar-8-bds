...
@php
    ...
    $inputHiddenTask   = '<input type="hidden" name="task" value="change-password">';
    ...
    $elements = [
        [
            ...
            'element' => $inputHiddenID . $inputHiddenTask . Form::submit('Save', ['class'=>'btn btn-success', 'name'=>'change-password']),
